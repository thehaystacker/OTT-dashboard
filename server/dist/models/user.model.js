    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 4, , 5]);
                    return [4 /*yield*/, jsonwebtoken_1.default.sign({ _id: user._id }, process.env.JWT_TOKEN_SECRET, common_1.default.jwtOptions)];
                case 2:
                    token = _a.sent();
                    user.tokens = __spreadArray(__spreadArray([], user.tokens), [{ token: token }]);
                ...
                case 4:
                    error_1 = _a.sent();
                    throw new Error("Authentication error " + error_1.message);
